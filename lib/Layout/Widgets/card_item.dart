  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SizedBox(
        height: 100,
        child: InkWell(
          onTap: (check)?()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>DescriptionScreen('assets/images/humberger.jpg',
            ...
            children:[
              Card(
                ...
                child: Row(
                  ...
                  children: [
                    Hero(tag: "meal$index",child: Image.asset('assets/images/humberger.jpg')),
